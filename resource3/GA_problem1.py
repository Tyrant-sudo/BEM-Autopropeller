...
class SphereWithConstraint(Problem):
    ...
    def get_base(self):
        ...
        draw_block(self.radius,self.c_R,self.pitch*180/np.pi,'OPTIMIZE_fig/','base',self.base_eta,self.base_T)
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        if self.s.v_inf >eps:
            ...
            draw_block(self.radius,cR_x[0],pitch_x[0]*180/np.pi,'OPTIMIZE_fig/',str(0),eta[0]/100,T[0])
        else:
            process_eta.append(np.mean(eta))
            draw_block(self.radius,cR_x[0],pitch_x[0]*180/np.pi,'OPTIMIZE_fig/',str(0),eta[0],T[0])
