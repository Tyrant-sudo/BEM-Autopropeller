...
# a = J
# print(a)
tck  = np.array(interpolate.splrep(J,CP))
CP  = np.array(interpolate.splev(J1,tck))
tck  = np.array(interpolate.splrep(J,CT))
CT  = np.array(interpolate.splev(J1,tck))
tck  = np.array(interpolate.splrep(J,eta))
eta = np.array(interpolate.splev(J1,tck))
